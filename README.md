...
<body>
  <div class="container">
    ...
    <div class="app-header">
      <div class="app-title">
        📊 Sistema Control de Clientes IVA
        <span class="badge-soft">Versión local (navegador)</span>
      </div>
      <small class="text-muted">
        Basado en Ley de IVA (13%) y Código Tributario de El Salvador. <br>
            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="section-subtitle">
                  ...
                  La clasificación (pequeño, mediano, gran contribuyente) se basa en los criterios de la DGII
                  sobre volumen de operaciones y obligaciones como agente de retención/percepción.
                </div>
                ...
                <form id="formCliente">
                  ...
                  <div class="mb-2">
                    <label class="form-label">Fecha inscripción IVA</label>
                    <input
                      type="date"
          ...
          <div class="col-lg-8">
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="section-subtitle">
                  Selecciona un cliente para usarlo luego en las declaraciones y en el análisis de ganancias.
                </div>
          ...
          <div class="col-lg-4">
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="section-subtitle">
                  Cálculo simplificado según normativa salvadoreña:  
                ...
                <form id="formDeclaracion">
                  ...
                  <div class="mb-2">
                    ...
                    <div id="infoRegimen" class="text-regimen mt-1">
                      Selecciona un cliente para ver su clasificación como contribuyente.
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="mb-2">
                    <label class="form-label">Débito fiscal</label>
                    <input
                      type="number"
                      step="0.01"
                      id="dec_debitoFiscal"
                  ...
                  <small class="text-muted d-block mt-3">
                    Nota: la clasificación como gran o mediano contribuyente también implica
                    obligaciones como agente de retención/percepción según el Código Tributario.
                  </small>
                </form>
              </div>
            </div>
          ...
          <div class="col-lg-8">
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="section-subtitle">
                  Vista rápida del estado de cumplimiento mensual por cliente.  
                  El campo <strong>“IVA favor acum.”</strong> muestra el IVA a favor acumulado por cliente.
                </div>
                ...
                <div class="mt-2 text-end">
                  <small class="text-muted">
                    Tip: más adelante esto se puede exportar a Excel o PDF.
                  </small>
                </div>
              </div>
            </div>
        ...
        <div class="row g-3">
          <div class="col-12">
            <div class="card h-100">
              <div class="card-body">
                <div class="section-title">
                  💰 Ganancias estimadas después de impuestos
                </div>
                <div class="section-subtitle">
                  Ganancia neta aproximada usando info de las declaraciones:  
                  <strong>Ganancia neta ≈ (Ventas - Compras) - (IVA pagado + Pago a cuenta + ISR estimado)</strong>.  
                  El IVA negativo se considera “a favor” y no se descuenta como pago del mes.
                </div>
                ...
                <small class="text-muted d-block mt-3">
                  Referencia legal: Ley del IVA (tasa general 13%) y Código Tributario de El Salvador  
                  sobre agentes de retención/percepción y clasificación de contribuyentes.
                </small>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    let declaraciones =
      JSON.parse(localStorage.getItem("declaracionesIVA")) || [];
    ...
    function mostrarNombreRegimen(valor) {
      ...
      if (v.includes("peque")) return "Pequeño contribuyente";
      if (v.includes("mediano")) return "Mediano contribuyente";
      if (v.includes("gran")) return "Gran contribuyente";
      // Compatibilidad con datos viejos: "Común" o "Régimen general"
      if (v.includes("común") || v.includes("general")) return "Mediano contribuyente";
      return valor;
    }
    ...
    function actualizarInfoRegimen() {
      ...
      if (isNaN(idxCliente) || !clientes[idxCliente]) {
        info.textContent = "Selecciona un cliente para ver su clasificación como contribuyente.";
        return;
      }
      ...
      if (reg === "Gran contribuyente") {
        info.textContent =
          "Gran contribuyente: clasificado así por la Administración Tributaria; usualmente actúa como agente de retención y percepción de IVA.";
      } else if (reg === "Mediano contribuyente") {
        info.textContent =
          "Mediano contribuyente: volumen de operaciones intermedio; también puede ser designado agente de retención/percepción según Código Tributario.";
      } else if (reg === "Pequeño contribuyente") {
        info.textContent =
          "Pequeño contribuyente: menor volumen de operaciones. Mantiene las obligaciones de IVA (13%) y renta, pero con menor impacto que medianos y grandes.";
      } else {
        info.textContent = "Clasificación personalizada de contribuyente.";
      }
    }

    // ======= CÁLCULO IMPUESTOS (El Salvador – simplificado) =======
    function recalcularImpuestos() {
      ...
      // IVA general 13% sobre ventas/compras gravadas
      const debito = ventasGrav * 0.13;
      const credito = comprasGrav * 0.13;
      ...
      // Pago a cuenta (1.5% sobre ventas gravadas + exentas)
      const basePagoCuenta = ventasGrav + ventasExen;
      const pagoCuenta = basePagoCuenta * 0.015;
      document.getElementById("dec_pagoCuenta").value = pagoCuenta.toFixed(2);

      // ISR estimado simple (25% sobre utilidad = ventas - compras)
      const utilidadEstimada =
        (ventasGrav + ventasExen) - (comprasGrav + comprasExen);
      const isrEstimado = utilidadEstimada > 0 ? utilidadEstimada * 0.25 : 0;
    ...
    function resetFormCliente() {
      ...
      document.getElementById("cli_regimen").value = "Pequeño contribuyente";
    }
    ...
    function eliminarCliente(i) {
      if (!confirm("¿Seguro que deseas eliminar este cliente? Esto no borra sus declaraciones existentes.")) return;
      clientes.splice(i, 1);
      guardarStorage();
      renderClientes();
      renderDeclaraciones();
    ...
    function eliminarDeclaracion(i) {
      if (!confirm("¿Seguro que deseas eliminar esta declaración?")) return;
    ...
    function renderGanancias() {
      ...
      declaraciones.forEach(d => {
        ...
        const ivaPagado = Math.max(0, Number(d.ivaPagar || 0)); // solo positivo
    ...
    // ======= EVENTO CAMBIO CLIENTE EN DECLARACIÓN =======
